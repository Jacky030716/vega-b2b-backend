...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddPersistenceServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<CleanArc.Application.Contracts.AdaptiveLearning.IChallengeGenerator, VoiceBridgeChallengeGenerator>();
        services.AddScoped<CleanArc.Application.Contracts.AdaptiveLearning.IChallengeGenerator, SpellCatcherChallengeGenerator>();
        services.AddScoped<CleanArc.Application.Contracts.AdaptiveLearning.IChallengeGenerator, SyllableSushiChallengeGenerator>();
        services.AddScoped<CleanArc.Application.Contracts.AdaptiveLearning.IChallengeGenerator, SpellingTestChallengeGenerator>();
        services.AddScoped<CleanArc.Application.Contracts.AdaptiveLearning.IAdaptiveLearningAgent, AdaptiveLearningAgent>();
